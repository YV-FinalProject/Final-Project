...
VALUES
    ...
    (1,29.99, 25.99, NOW(), NOW(),'Corn Gluten Meal','A common late-season, winter preparation additive, corn gluten is a good soil stabilizer for winter','https://example.com/images/corn_gluten_meal.jpg'),
    ...
    (3, 4.45, NULL, NOW(), NOW(),'Cordon Tomato Sungold seedling','Tomato seedling','https://example.com/images/cordon_tomato_seedling.jpg'),
