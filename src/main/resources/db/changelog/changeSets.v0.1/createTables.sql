...
CREATE TABLE Products (ProductID BIGINT AUTO_INCREMENT NOT NULL, CategoryID BIGINT NULL, DiscountPrice DOUBLE NULL, Price DOUBLE NULL, CreatedAt datetime NULL, UpdatedAt datetime NULL, Description VARCHAR(255) NULL, ImageURL VARCHAR(255) NULL, Name VARCHAR(255) NULL, CONSTRAINT PK_PRODUCTS PRIMARY KEY (ProductID));
...
CREATE TABLE OrderItems (OrderItemID BIGINT AUTO_INCREMENT NOT NULL, OrderID BIGINT NULL, ProductID BIGINT NULL, Quantity INT NULL, PriceAtPurchase DECIMAL NULL, CONSTRAINT PK_ORDERITEMS PRIMARY KEY (OrderItemID));
