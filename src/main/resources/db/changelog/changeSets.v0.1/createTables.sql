...
CREATE TABLE Orders (OrderID BIGINT AUTO_INCREMENT NOT NULL, UserID BIGINT NULL, CreatedAt datetime NULL, DeliveryAddress VARCHAR(255) NULL, ContactPhone VARCHAR(255) NULL, DeliveryMethod VARCHAR(255) NULL, Status ENUM('PENDING PAYMENT', 'PAID', 'ON THE WAY', 'DELIVERED', 'CANCELED') NULL, UpdatedAt datetime NULL, CONSTRAINT PK_ORDERS PRIMARY KEY (OrderID));
