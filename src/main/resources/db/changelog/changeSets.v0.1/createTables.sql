...
CREATE TABLE Users (UserID BIGINT AUTO_INCREMENT NOT NULL, Name VARCHAR(255) NULL, Email VARCHAR(255) NULL, PhoneNumber VARCHAR(255) NULL, PasswordHash VARCHAR(255) NULL, Role ENUM('CLIENT', 'ADMINISTRATOR') NULL, CONSTRAINT PK_USERS PRIMARY KEY (UserID));

-- changeset yulia:create_table_products
CREATE TABLE Products (ProductID BIGINT AUTO_INCREMENT NOT NULL, CategoryID BIGINT NOT NULL, Price DECIMAL (10, 2) NULL, DiscountPrice DECIMAL (10, 2) NULL, CreatedAt datetime NULL, UpdatedAt datetime NULL, Name VARCHAR(255) NULL, Description VARCHAR(255) NULL, ImageURL VARCHAR(255) NULL, CONSTRAINT PK_PRODUCTS PRIMARY KEY (ProductID));

-- changeset yulia:create_table_categories
CREATE TABLE Categories (CategoryID BIGINT AUTO_INCREMENT NOT NULL, Name VARCHAR(255) NULL, CONSTRAINT PK_CATEGORIES PRIMARY KEY (CategoryID));

-- changeset yulia:create_table_cart
CREATE TABLE Cart (CartID BIGINT AUTO_INCREMENT NOT NULL,
UserID BIGINT NOT NULL, CONSTRAINT PK_CART PRIMARY KEY (CartID), UNIQUE (UserID));

-- changeset yulia:create_table_cartitems
CREATE TABLE CartItems (CartItemID BIGINT AUTO_INCREMENT NOT NULL, CartID BIGINT NOT NULL,
ProductID BIGINT NOT NULL, Quantity INT NULL, CONSTRAINT PK_CARTITEMS PRIMARY KEY (CartItemID));

-- changeset yulia:create_table_favorites
CREATE TABLE Favorites (FavoriteID BIGINT AUTO_INCREMENT NOT NULL, ProductID BIGINT NOT NULL, UserID BIGINT NOT NULL, CONSTRAINT PK_FAVORITES PRIMARY KEY (FavoriteID));

-- changeset yulia:create_table_orders
CREATE TABLE Orders (OrderID BIGINT AUTO_INCREMENT NOT NULL, UserID BIGINT NULL, CreatedAt datetime NULL, DeliveryAddress VARCHAR(255) NULL, ContactPhone VARCHAR(255) NULL, DeliveryMethod VARCHAR(255) NULL, Status ENUM('CREATED','PENDING PAYMENT', 'PAID', 'ON THE WAY', 'DELIVERED', 'CANCELED') NULL, UpdatedAt datetime NULL, CONSTRAINT PK_ORDERS PRIMARY KEY (OrderID));
