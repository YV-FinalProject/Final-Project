...
CREATE TABLE Users (UserID BIGINT AUTO_INCREMENT NOT NULL, Name VARCHAR(30) NULL, Email VARCHAR(100) NULL, PhoneNumber VARCHAR(15) NULL, PasswordHash VARCHAR(100) NULL, Role ENUM('CLIENT', 'ADMINISTRATOR') NULL, CONSTRAINT PK_USERS PRIMARY KEY (UserID));
