...
CREATE TABLE Users (UserID BIGINT AUTO_INCREMENT NOT NULL, Name VARCHAR(50) NULL, Email VARCHAR(100) NULL UNIQUE, PhoneNumber VARCHAR(20) NULL, PasswordHash VARCHAR(255) NULL, Role ENUM('CLIENT', 'ADMINISTRATOR') NULL, CONSTRAINT PK_USERS PRIMARY KEY (UserID));
