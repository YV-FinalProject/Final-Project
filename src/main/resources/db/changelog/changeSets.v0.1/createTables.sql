...
CREATE TABLE Products (ProductID BIGINT AUTO_INCREMENT NOT NULL, CategoryID BIGINT NULL, Price DECIMAL (10, 2) NULL, DiscountPrice DECIMAL (10, 2) NULL, CreatedAt datetime NULL, UpdatedAt datetime NULL, Name VARCHAR(255) NULL, Description VARCHAR(255) NULL, ImageURL VARCHAR(255) NULL, CONSTRAINT PK_PRODUCTS PRIMARY KEY (ProductID));
