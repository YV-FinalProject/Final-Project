...
//                        .with(SecurityMockMvcRequestPostProcessors.user("michaelnguyen@example.com").roles("ADMINISTRATOR"))
...
//                        .content(objectMapper.writeValueAsString(favoriteResponseDto))
//                        .with(SecurityMockMvcRequestPostProcessors.user("michaelnguyen@example.com").roles("ADMINISTRATOR"))
//                        .with(SecurityMockMvcRequestPostProcessors.csrf())).andDo(print())
//                .andExpect(status().isOk());
//    }
