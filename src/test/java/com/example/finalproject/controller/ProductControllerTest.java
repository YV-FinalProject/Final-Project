...
class ProductControllerTest {
    ...
    private ProductResponseDto productExpected1, productExpected2;
    ...
    @BeforeEach
    void setUp() {
        productExpected1 = ProductResponseDto.builder()
                .name("Name 1")
                ...
                .CategoryId(1L)
                .build();
        productExpected2 = ProductResponseDto.builder()
                .name("Name 1")
    ...
    void getProductsById() throws Exception {
        ...
        this.mockMvc.perform(get("/products/{id}",1)).andDo(print())
                ...
                .andExpect(jsonPath("$.productsId").exists())
                .andExpect(jsonPath("$.productsId").value(1));
    }
...
//        when(productServiceMock.insertProduct(any(ProductRequestDto.class))).thenReturn(productExpected1);
